  ...
  extends Thread
{
  ...
  public void run()
  {
    try
    {
      this.fu.getTxtLog().append("Posting to : " + this.fu.getTxtPostURL().getText());
      ...
      if (!this.fu.getTxtTitle().getText().isEmpty())
      {
        ...
        data.append("&imdbID=").append(this.fu.getTxtIMDUrl().getText().split("/")[4]);
      }
      ...
      if (!this.fu.getTxtThrailer().getText().isEmpty()) {
        data.append("&trailer=").append("https://www.youtube.com/embed/").append(this.fu.getTxtThrailer().getText());
      } else {
